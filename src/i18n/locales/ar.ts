...
export const ar = {
  ...
  hero: {
    eyebrow: "استوديو مستقل للتجارة الرقمية",
    heading: {
      leading: "مواقع ومتاجر مبنية للعلامات التجارية الحديثة.",
      emphasis: "تصميم أفضل. تنفيذ أسرع.",
    },
    description:
      "أبني وأطوّر تجارب Shopify وWooCommerce والواجهات الأمامية للعلامات التجارية النامية.",
    actionsLabel: "إجراءات القسم الرئيسي",
    primaryCta: "ابدأ مشروعك",
    primaryCtaAriaLabel: "ابدأ مشروعك مع CZ Pixel عبر واتساب",
    secondaryCta: "استكشف المشاريع",
    secondaryCtaAriaLabel: "استكشف مشاريع CZ Pixel",
    cvLink: "حمّل سيرتي الذاتية",
    ...
    metrics: [
      ...
      { value: "30+", label: "عميل وعلامة تجارية تم دعمهم" },
